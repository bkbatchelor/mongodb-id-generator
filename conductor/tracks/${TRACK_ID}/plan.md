...
- [ ] Task: Initialize Gradle project with Java 21, Kotlin DSL, and Spring Boot 3.5.9
- [ ] Task: Configure build.gradle.kts with dependencies: Spring Data MongoDB, ArchUnit, JUnit 5, jqwik, Pitest, and Testcontainers
